...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.dashboard') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.machines.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.tournaments.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
        ...
        <span class="kt-menu__link-text"> Competições</span>
    </a>
</li>
<li class="kt-menu__item kt-menu__item--submenu">
...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.modules.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.classes.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
...
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.attachments.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
        ...
        <span class="kt-menu__link-text"> Anexos</span>
    </a>
</li>
<li class="kt-menu__item kt-menu__item--submenu">
    <a href="{{ route('admin.announcements.index') }}" class="kt-menu__link">
        <span class="svg-icon svg-icon-primary svg-icon-2x kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <rect x="0" y="0" width="24" height="24" />
        ...
        <span class="kt-menu__link-text"> Comunicados</span>
    </a>
</li>
